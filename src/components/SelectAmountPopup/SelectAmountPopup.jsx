    ...
    return (
        ...
        >
            <ScrollView style={{}}>
                ...
                <View style={{ flexDirection: "row", flexWrap: "wrap", justifyContent: 'space-between', marginTop: verticalScale(10) }}>
                    {
                        priceData.map((item) => {
                            ...
                            return (
                                <TouchableOpacity
                                    ...
                                    style={[styles.priceCard, {
                                        ...
                                        backgroundColor: (action === "withdraw" && item.price > wallateBalance) ? uiColours.LIGHT_GRAY : uiColours.WHITE_TEXT
                                    }]}
                                    onPress={() => {
                ...
                <InputText
                    ...
                    inputContainer={{}}
                />
                {showError && <Text style={[appStyles.smallTextGray, { color: uiColours.RED }]}>
                ...
                {buttonActive && <PayWithFlutterwave
                    onRedirect={(data) => { handleOnRedirect(data, seletedAmount) }}
                    options={{
                        tx_ref: generateTransactionRef(10),
                        authorization: 'FLWPUBK_TEST-88427faea02467d361ea8d1203a956e6-X',
                        customer: {
