...
const DestinationHistory = () => {
    ...
    return (
        <View style={{ paddingHorizontal: scale(16), marginVertical: verticalScale(16) }}>
                                ...
                                return (
                                    ...
                                    >
                                        <View style={styles.vehicleTypeIcon}>
                                            <Images.scooter height={moderateScale(24)} width={moderateScale(24)} />
                                        </View>
                                        <View style={[commonStyles.flexRowAlnCtrJutySpaceBetween, { flex: 1, alignItems: 'flex-start' }]}>
                                            <View>
                                                <Text style={appStyles.smallTextGray}>
                                                    Send to <Text style={appStyles.smallTextPrimary}>{item?.destination}</Text>
                                                </Text>
                                                <Text style={appStyles.smallTextGray}>
                                                    {item.time}
                                                </Text>
